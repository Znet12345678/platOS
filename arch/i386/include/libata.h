...
int ata_read24(uint16_t port,uint8_t slave,void *buf,unsigned int lba,unsigned int sc);
int ata_write24(uint16_t port,uint8_t slave,void *buf,unsigned int lba,unsigned int sc);
